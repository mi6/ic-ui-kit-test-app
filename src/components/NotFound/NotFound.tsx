  ...
  return redirect ? (
    ...
    <IcSectionContainer aligned="full-width">
      <IcEmptyState
        ...
        body="Use the actions below to either go back to the home page or submit feedback."
      >
        <SlottedSVG
          slot="image"
      ...
      >
        <IcTypography>
          We're sorry you have found something on our site that isn't working -
        ...
        />
        <IcTypography>
          Please provide the date you found these issues.
        </IcTypography>
